...
@interface TJListSelector ()<UISearchBarDelegate>
...
- (void)finishSelected
{
    ...
    if ([_delegate respondsToSelector:@selector(listSelector:didFinishSelect:)]) {
        [_delegate listSelector:self didFinishSelect:self.selectedContactList];
    }
