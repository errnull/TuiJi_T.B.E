...
- (void)viewWillLayoutSubviews{
    ...
    _layer.frame = self.videoView.bounds;
}
        ...
        for (int i=1; i<_filterArray.count; i++) {
            ...
            switch (i) {
                case 1:
                {
                    ...
                    [self imageArray:imageArray addFilter:[[FWNashvilleFilter alloc] init]];
                ...
                case 2:
                {
                    ...
                    [self imageArray:imageArray addFilter:[[FWLordKelvinFilter alloc] init]];
                ...
                case 3:
                {
                    [self imageArray:imageArray addFilter:[[FWRiseFilter alloc] init]];
                ...
                case 4:
                {
                    ...
                    [self imageArray:imageArray addFilter:[[FWXproIIFilter alloc] init]];
                ...
                case 5:
                {
                    [self imageArray:imageArray addFilter:[[FWWaldenFilter alloc] init]];
                ...
                case 6:
                {
                    ...
                    [self imageArray:imageArray addFilter:[[FWEarlybirdFilter alloc] init]];
                ...
                case 7:
                {
                    [self imageArray:imageArray addFilter:[[FWToasterFilter alloc] init]];
                ...
                case 8:
                {
                    [self imageArray:imageArray addFilter:[[FWBrannanFilter alloc] init]];
                ...
                case 9:
                {
                    [self imageArray:imageArray addFilter:[[FWInkwellFilter alloc] init]];
                ...
                case 10:
                {
                    ...
                    [self imageArray:imageArray addFilter:[[FWSierraFilter alloc] init]];
                ...
                case 11:
                {
                    ...
                    [self imageArray:imageArray addFilter:[[FWHefeFilter alloc] init]];
                ...
                case 12:
                {
                    ...
                    [self imageArray:imageArray addFilter:[[FWValenciaFilter alloc] init]];
                ...
                case 13:
                {
                    ...
                    [self imageArray:imageArray addFilter:[[FWSutroFilter alloc] init]];
                ...
                case 14:
                {
                    ...
                    [self imageArray:imageArray addFilter:[[FWAmaroFilter alloc] init]];
