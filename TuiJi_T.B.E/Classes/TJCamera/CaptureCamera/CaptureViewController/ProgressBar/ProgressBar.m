...
#define BAR_BLUE_COLOR TJColorBlack
#define BAR_RED_COLOR color(224, 66, 39, 1)
#define BAR_BG_COLOR TJColorGrayBg

#define BAR_MIN_W 0.05 * TJWidthDevice

#define BG_COLOR color(11, 11, 11, 1)

#define INDICATOR_W 16
#define INDICATOR_H (BAR_H)
...
- (void)initalize
{
    ...
    // BarView
    self.barView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, BAR_H)];
    ...
    _progressIndicator.backgroundColor = [UIColor blackColor];
