...
{
    if (TJStringIsNull(fromPath) || TJStringIsNull(toPath) ) {
        return NO;
    }
...
{
    if (GJCFCheckObjectNull(anObject) || TJStringIsNull(toPath)) {
        return NO;
    }
...
{
    if (GJCFCheckObjectNull(anObject) || TJStringIsNull(file)) {
        return NO;
    }
