...
- (void)setHighlighted:(BOOL)highlighted
{
    ...
    if (_highlighted) {
        ...
        [attriString addAttributes:[stringStyle foregroundColorAttributedDictionary] range:TJStringRange(self.text)];
...
- (void)setText:(NSString *)text
{
    ...
    GJCFCoreTextAttributedStringStyle *stringStyle = [[GJCFCoreTextAttributedStringStyle alloc]init];
    stringStyle.font = self.font? self.font:TJFontWithSize(14);
    ...
    [attributedString addAttributes:[stringStyle attributedDictionary] range:TJStringRange(text)];
    [attributedString addAttributes:[paragraphStyle paragraphAttributedDictionary] range:TJStringRange(text)];
