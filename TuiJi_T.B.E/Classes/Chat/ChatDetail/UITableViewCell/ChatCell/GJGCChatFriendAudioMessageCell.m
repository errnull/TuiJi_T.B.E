...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        [self.bgshadowView addSubview:self.audioPlayIndicatorView];
        ...
        self.downloadIndicator.gjcf_centerY = self.bgshadowView.gjcf_height/2;
        [self.bgshadowView addSubview:self.downloadIndicator];
...
- (void)setContentModel:(GJGCChatContentBaseModel *)contentModel
{
    ...
    self.bgshadowView.gjcf_width = [self getBubbleWidthByVoiceDuration:audioDuration] + 20;
    ...
    if (self.isFromSelf) {
        self.audioTimeLabel.gjcf_right = self.bgshadowView.gjcf_left - 5;
        ...
        self.audioPlayIndicatorView.gjcf_rightToSuper = self.audioPlayIndicatorView.image.size.width +40;
        self.audioPlayIndicatorView.gjcf_centerY = self.bgshadowView.gjcf_height/2;
        
        self.downloadIndicator.gjcf_left = 5 + 5;

    }else{
        self.audioTimeLabel.gjcf_left = self.bgshadowView.gjcf_right + 5;
        ...
        self.audioPlayIndicatorView.gjcf_left = 50;
        self.audioPlayIndicatorView.gjcf_centerY = self.bgshadowView.gjcf_height/2;
        
        self.downloadIndicator.gjcf_right = self.bgshadowView.gjcf_width - 5 - 5;

    }
    self.statusButtonOffsetAudioDuration = self.audioTimeLabel.gjcf_width;
    self.audioTimeLabel.gjcf_centerY = self.bgshadowView.gjcf_centerY;
