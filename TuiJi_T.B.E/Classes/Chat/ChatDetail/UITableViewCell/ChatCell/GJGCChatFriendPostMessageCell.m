...
//  ZYChat
//
//  Created by ZYVincent on 14-12-11.
...
- (void)setContentModel:(GJGCChatContentBaseModel *)contentModel
{
    ...
    /* 重设气泡 */
    self.bgshadowView.gjcf_height = self.contentImageView.gjcf_bottom + self.contentInnerMargin;
    
    CGFloat maxWidth = MAX(self.titleLabel.gjcf_width, self.contentImageView.gjcf_width);
    self.bgshadowView.gjcf_width = maxWidth + 2*self.contentBordMargin + 20;
