...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        self.bgshadowView.gjcf_width = maxTextContentWidth + 13*2 + 20;
        ...
        self.contentLabel.gjcf_left = self.titleLabel.gjcf_left + 50;
...
- (void)setContentModel:(GJGCChatContentBaseModel *)contentModel
{
    ...
    self.bgshadowView.gjcf_height = self.contentLabel.gjcf_bottom + self.contentInnerMargin;
    
    /* 重设背景图片 */
//    self.bgshadowView.image = [self bubbleBackImage];
