...
//  ZYChat
//
//  Created by ZYVincent on 15/6/30.
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        self.bgshadowView.gjcf_width = self.bubbleFrontImageView.gjcf_width + 20;
        ...
        [self.bgshadowView insertSubview:self.contentStateBack belowSubview:self.contentLabel];
        
        [self.bgshadowView addSubview:self.bubbleFrontImageView];
...
- (void)setContentModel:(GJGCChatContentBaseModel *)contentModel
{
    ...
    self.bgshadowView.gjcf_height = self.contentStateBack.gjcf_bottom;
    
    self.bubbleFrontImageView.gjcf_height = self.bgshadowView.gjcf_height;
