...
+ (NSDictionary *)chatCellContentTypeDict
{
    return @{
             ...
             @(GJGCChatFriendContentTypeVideo) : @"GJGCChatFriendVideoMessageCell",
             
             @(GJGCChatFriendContentTypeLocation) : @"GJGCChatFriendContentTypeLocationCell",
             
             @(GJGCChatFriendContentTypeTransmit) : @"GJGCChatFriendContentTypeTransmitCell",
             
             @(GJGCChatFriendContentTypeFriendCard) : @"GJGCChatFriendContentTypeFriendCardCell",
