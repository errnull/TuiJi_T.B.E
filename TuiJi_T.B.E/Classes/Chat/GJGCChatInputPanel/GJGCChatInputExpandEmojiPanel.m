...
- (void)initSubViews
{
    ...
    bottomBarBack.backgroundColor = TJColorWhiteBg;
    ...
    seprateLine.backgroundColor = TJColorWhiteBg;
    ...
    [self.sendButton setBackgroundImage:GJCFQuickImageByColorWithSize(TJColorWhiteBg, self.sendButton.gjcf_size) forState:UIControlStateNormal];
