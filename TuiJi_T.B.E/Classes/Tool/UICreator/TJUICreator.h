...
#define TJRectFromSize(size) CGRectMake(0,0,size.width,size.height)

@class TJAnimTextField;
@class TJAgreeView;
@class TJVerityButton;
@class TJRegionView;
@class TJKeyValueTextLabel;
//用于按钮中，文字和图片相对方向
...
@class TJInPutView;
@interface TJUICreator : NSObject
